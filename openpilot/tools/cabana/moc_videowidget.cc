...
struct qt_meta_stringdata_StreamCameraView_t {
    QByteArrayData data[1];
    char stringdata0[17];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_StreamCameraView_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_StreamCameraView_t qt_meta_stringdata_StreamCameraView = {
    {
QT_MOC_LITERAL(0, 0, 16) // "StreamCameraView"
...
static const uint qt_meta_data_StreamCameraView[] = {
...
void StreamCameraView::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    (void)_o;
    (void)_id;
    (void)_c;
...
QT_INIT_METAOBJECT const QMetaObject StreamCameraView::staticMetaObject = { {
    QMetaObject::SuperData::link<CameraWidget::staticMetaObject>(),
    qt_meta_stringdata_StreamCameraView.data,
    qt_meta_data_StreamCameraView,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
const QMetaObject *StreamCameraView::metaObject() const
{
    return QObject::d_ptr->metaObject ? QObject::d_ptr->dynamicMetaObject() : &staticMetaObject;
}

void *StreamCameraView::qt_metacast(const char *_clname)
{
    if (!_clname) return nullptr;
    if (!strcmp(_clname, qt_meta_stringdata_StreamCameraView.stringdata0))
        return static_cast<void*>(this);
    return CameraWidget::qt_metacast(_clname);
}

int StreamCameraView::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
